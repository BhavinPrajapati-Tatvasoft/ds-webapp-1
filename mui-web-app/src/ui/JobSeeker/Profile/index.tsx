...
const JobSeekerProfile: React.FC = () => {
  ...
  const skills = ["Prototyping", "Figma", "Wireframe", "UX"];
              ...
              <div className="fill-upload">
                <div className="fill-upload-content">
                  <div className="doc-wrapper">
                    <Typography className="primary-text pb-0">
                      Resume12.PDF
                    </Typography>
                    <IconButton color="primary">
                      <Avatar src={deleteIcon} alt="Delete" />
                    </IconButton>
                  </div>
                  <Typography className="doc-type">3MB</Typography>
                </div>
      ...
      >
        ...
        <DialogContent>
          ...
          <FormControl required sx={{ mb: 1.5 }}>
            <InputLabel id="positions">Positions</InputLabel>
            <Select labelId="positions" label="Positions">
          ...
          <Button
            variant="text"
            sx={{ display: "flex", ml: "-6px", mb: { xs: 0.5, md: 1 } }}
            startIcon={<Avatar src={plusPrimaryIcon} alt="Add" />}
          >
            Add New Position
          </Button>
          ...
          <FormControl required sx={{ mb: 1.5 }}>
            ...
            <Select labelId="education" label="Education">
              <MenuItem value={1}>Option 1</MenuItem>
              <MenuItem value={2}>Option 2</MenuItem>
              <MenuItem value={3}>Option 3</MenuItem>
            </Select>
        ...
        <DialogContent>
          ...
          <ul className="skill-list">
            <li className="flex-row">
              ...
              <Typography variant="body1" className="title-color fw-500 pb-0">
                Prototypoing
              </Typography>
